...
@shared_task(autoretry_for=(MemoryError,), default_retry_delay=60, base=TaskWithFailure)
def generate_part_thumbnails(instance_pk=None, user_pk=None, project_slug=None, 
